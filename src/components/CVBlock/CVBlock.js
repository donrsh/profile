  ...
  return (
    <div id='CV-Block'>
      ...
      >
        <ul className='info-list'>
          <li>
            {myWorks.RWDExercise.name}
            {' - '}
            {myWorks.RWDExercise.desc}
            {myWorks.RWDExercise.append}
          </li>

          <li>
            {myWorks.MMPCalculator.name}
            {' - '}
            {myWorks.MMPCalculator.desc}
            {myWorks.MMPCalculator.append}
          </li>

          <li>
            {myWorks.RainDropAnimation.name}
            {' - '}
            {myWorks.RainDropAnimation.desc}
            {myWorks.RainDropAnimation.append}
          </li>
        </ul>
      </InfoBlock>
    </div>
